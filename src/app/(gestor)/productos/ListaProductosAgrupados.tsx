...
type ProductosArray = Prisma.PromiseReturnType<typeof import('@/lib/data/products').getProductosByNegocioId>;
        ...
        <div key={categoriaNombre}>
          ...
          <div className="space-y-3">
            {groupedProducts[categoriaNombre].map((producto) => {
                ...
                // --- LÓGICA VISUAL DE PROMOCIÓN Y PRECIOS ---
                ...
                return (
                  ...
                  >
                                ...
                                <>
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        {producto.tipo_promo !== 'DESCUENTO_SIMPLE' && (
                                            <span className="text-[9px] font-bold text-purple-700 bg-purple-100 px-1 rounded uppercase">
                                                {promoLabel}
                                            </span>
                                        )}
                                    </div>
                    ...
                    <div className="flex items-center justify-end gap-1 sm:ml-auto">
                        ...
                        {/* --- LÓGICA DE BOTÓN: Eliminar vs Reactivar --- */}
                        {producto.activo ? (
